...
**Bangladesh Bengali (`bn-Beng-BD`)**, **Vietnamese (`vi-Latn-VN`)**, and **Latin (`la-Latn`)** are also in the OpenLogic pipeline. They are not promoted into the frozen Top 10. Bangladesh's existing early-numeracy and worked-answer design and Vietnamese self-study/prerequisite design supply reusable pedagogical evidence, not a requirement to reshape the whole OpenLogic text into those textbooks. Latin is a cultural and didactic commission rather than an access-rank claim. Keep faithful full-source translation distinct from optional local learning pathways.
...
For Latin, produce one source-faithful 722-unit Neo-Latin semantic edition and a separately labelled English–Latin learner companion with vocabulary, morphology and reading aids. Use plain, intelligible active Latin rather than faux-Ciceronian circumlocution. The initial canon spine is the Vatican [Latinitas foundation and *Lexicon recentis Latinitatis*](https://www.vatican.va/roman_curia/institutions_connected/latinitas/documents/index_en.htm) for contemporary coinage practice, the [online abridged lexicon](https://press.vatican.va/roman_curia/institutions_connected/latinitas/documents/rc_latinitas_20040601_lexicon_it.html), historical logical Latin including the [Latin *Organon* manuscript](https://libwww.freelibrary.org/digital/item/3184), scientific prose such as Euler's [*Introductio in analysin infinitorum*](https://doi.org/10.3931/e-rara-8740), and the University of Turin's [Peano works catalogue](https://www.asut.unito.it/peano/opere.html). Peano's *Formulario mathematico* and *Latino sine flexione* expose modern symbolic-logic vocabulary and interlanguage design, but they do not license stripping inflection from the Latin edition. Every modern term must carry a source/sense decision, formation rationale, alternatives, confidence and exact occurrence links under the shared decision schema.
