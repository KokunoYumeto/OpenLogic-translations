...
Dedicated full-edition tasks are producing Punjabi (Pakistan, Shahmukhi), Bengali (India), Marathi, Telugu, Tamil (India), Javanese, Gujarati and Pashto (Pakistan) editions against the same verified 722-file English source. Four initial chapter releases are now publicly byte-verified:

| Edition | Read or download | Published reader scope |
|---|---|---|
| Gujarati | [repository](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/releases/tag/sets-v0.1.0) | Complete Sets chapter, **7/722** source units; PDF and offline MathML HTML. |
...
| Bengali (India) | [repository](https://github.com/KokunoYumeto/OpenLogic-bn-Beng-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-bn-Beng-IN/releases/tag/v0.1.0-sets) | Sets chapter plus its alternative explanation, **8/722** source units. |
| Pashto (Pakistan) | [repository](https://github.com/KokunoYumeto/openlogic-ps-Arab-PK) · [release](https://github.com/KokunoYumeto/openlogic-ps-Arab-PK/releases/tag/v0.1.0-sets) · [DOI](https://doi.org/10.5281/zenodo.22307198) | Complete Sets chapter, **7/722** rendered units; additional front-matter drafts are not counted as reader coverage. |

All twelve GitHub release files matched anonymous size/hash checks; the three Pashto Zenodo files matched the GitHub payloads. See [GitHub receipts](evidence/NEW_CHAPTER_PUBLIC_READBACK_20260904.json) and [Zenodo receipts](evidence/PASHTO_ZENODO_READBACK_20260904.json). These are **partial editions**, not completed books. Published coverage follows the tagged edition records; byte verification is not independent linguistic certification. Their same-agent semantic, canon-use, build and visual evidence remains inspectable in each edition repository. Later local drafts are not included in these release counts.

The [ownership register](catalogue/ownership.json) retains all eight full-edition assignments. Punjabi, Telugu, Tamil and Javanese have source-aligned drafts but no release verified in this catalogue checkpoint. Bangladesh Bengali and Vietnamese remain additional, unassigned candidates. The [workflow evidence check](evidence/CANON_WORKFLOW_CHECK_20260904.json) records independent canon-file/reference checks and the recovered-canon handoff repair, with its limits stated explicitly.
