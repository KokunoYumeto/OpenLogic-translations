...
The current common source snapshot is [OpenLogic commit `9620cc7…`](https://github.com/OpenLogicProject/OpenLogic/tree/9620cc73f9c8e0ad003c514a5d3748f29611c4c0), containing 722 tracked English content `.tex` files. Coverage of those files and coverage of a reading PDF are reported separately. In particular, “722 translated sources” does **not** mean that all 722 are present in one reader.
...
| Hindi | [repository](https://github.com/KokunoYumeto/open-logic-hi) · [release](https://github.com/KokunoYumeto/open-logic-hi/releases/tag/HI-OLP-PUB-0005) · [DOI](https://doi.org/10.5281/zenodo.21920511) | **722/722 and published.** An 842-page A4 reader and public provenance package have recorded anonymous readback. |
...
| Brazilian Portuguese | [repository](https://github.com/KokunoYumeto/OpenLogic-pt-BR) · [latest public GitHub release](https://github.com/KokunoYumeto/OpenLogic-pt-BR/releases/tag/v2026-08-20-r4) · [concept DOI](https://doi.org/10.5281/zenodo.21973104) | **722/722 local r5 reader passes QA; public mirrors drift.** Zenodo currently exposes the r5 reader bytes, but GitHub has no r5 release although its README links one. |
