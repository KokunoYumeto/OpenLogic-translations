...
Dedicated full-edition tasks are producing Punjabi (Pakistan, Shahmukhi), Bengali (India), Marathi, Telugu, Tamil (India), Javanese, Gujarati and Pashto (Pakistan) editions against the same verified 722-file English source. Seven edition repositories now have publicly byte-verified chapter releases:

| Edition | Read or download | Published reader scope |
|---|---|---|
| Punjabi (Pakistan, Shahmukhi) | [repository](https://github.com/KokunoYumeto/OpenLogic-pnb-Arab-PK) · [release](https://github.com/KokunoYumeto/OpenLogic-pnb-Arab-PK/releases/tag/v0.1.0) · [DOI](https://doi.org/10.5281/zenodo.22308437) | Complete Sets chapter in Naskh and Nastaliq, **7 rendered units**; **21/722** source-aligned translations including Relations and the opening Functions units. |
| Gujarati | [repository](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/releases/tag/sets-relations-v0.2.0) · [DOI](https://doi.org/10.5281/zenodo.22308102) | Complete Sets and Relations chapters, **16/722** source units; PDF and offline MathML HTML. |
| Marathi | [repository](https://github.com/KokunoYumeto/OpenLogic-mr-Deva-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-mr-Deva-IN/releases/tag/foundations-v0.2) · [DOI](https://doi.org/10.5281/zenodo.22307961) | Complete Sets and Relations chapters, **16/722** source/reader units. |
| Bengali (India) | [repository](https://github.com/KokunoYumeto/OpenLogic-bn-Beng-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-bn-Beng-IN/releases/tag/v0.2.0-sets-relations) | Sets and Relations; **18 translated files**, including one alternative driver supplied as configuration. Reader has15 prose sections; this is not a claim of18 separately rendered units. |
...
| Tamil (India) | [repository](https://github.com/KokunoYumeto/OpenLogic-ta-Taml-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-ta-Taml-IN/releases/tag/v0.1.0-sets) | Complete Sets chapter, **7 rendered units**; **16/722** editable drafts including Relations. |
...
The [current cumulative readback](evidence/CUMULATIVE_PUBLIC_READBACK_20260904.json) verifies twelve GitHub assets for Gujarati, Bengali, Pashto and Tamil. [Pashto Zenodo readback](evidence/PASHTO_CUMULATIVE_ZENODO_READBACK_20260904.json) verifies six files, including the three preserved predecessor files. The historical [Telugu/Marathi delivery check](evidence/DELIVERY_PUBLIC_READBACK_20260904.json) verifies seven earlier GitHub assets; [Marathi](evidence/MARATHI_ZENODO_READBACK_20260904.json) matches its Zenodo payload. The current [Telugu v0.2 manager readback](evidence/TELUGU_V020_PUBLIC_READBACK_20260904.json) verifies six matching GitHub/Zenodo files, all nine live Pages files, and replays all 396 source/target/canon segment records in the 23-unit checkpoint. The [Punjabi manager readback](evidence/PUNJABI_PUBLIC_READBACK_20260904.json) verifies seven matching GitHub/Zenodo assets and a focused frozen-source/canon audit; it also records a non-corrupting LF/CRLF provenance representation difference for repair. Earlier releases remain available. These are **partial editions**, not completed books. Byte verification is not independent linguistic certification. Published source/reader scope follows the tagged edition records; later local drafts are not counted. Bengali and Marathi offline HTML have structural checks, but browser layout verification remains explicitly pending in their published evidence.

The [ownership register](catalogue/ownership.json) retains all eight full-edition assignments. Javanese has source-aligned drafts but no release verified in this catalogue checkpoint; Punjabi now has a verified partial release. Bangladesh Bengali and Vietnamese remain additional, unassigned candidates. The [workflow evidence check](evidence/CANON_WORKFLOW_CHECK_20260904.json) records independent canon-file/reference checks and the recovered-canon handoff repair, with its limits stated explicitly.
