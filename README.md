...
|---|---|---|
| Gujarati | [repository](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN) · [release](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/releases/tag/sets-relations-v0.2.0) | Complete Sets and Relations chapters, **16/722** source units; PDF and offline MathML HTML. |
